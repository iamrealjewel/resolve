          ...
          <Table>
            <TableHeader className="bg-muted/30 border-b">
              <TableRow className="hover:bg-transparent">
                <TableHead className="w-[120px] font-semibold text-muted-foreground text-[10px] uppercase tracking-wider pl-8 h-12">Ticket ID</TableHead>
                <TableHead className="min-w-[250px] font-semibold text-muted-foreground text-[10px] uppercase tracking-wider h-12">Incident Title</TableHead>
                <TableHead className="w-[180px] font-semibold text-muted-foreground text-[10px] uppercase tracking-wider h-12">Reporter</TableHead>
                
                {/* ORGANIZATIONAL SCOPE FILTER */}
                <TableHead className="w-[180px] font-semibold text-muted-foreground text-[10px] uppercase tracking-wider h-12">
                  <Popover>
                ...
                <TableHead className="w-[60px] font-semibold text-muted-foreground text-[10px] uppercase tracking-wider h-12 text-center">Docs</TableHead>
                ...
                {/* STATUS FILTER */}
                <TableHead className="w-[130px] font-semibold text-muted-foreground text-[10px] uppercase tracking-wider h-12">
                  <Popover>
                    <PopoverTrigger className="flex items-center gap-2 hover:text-[#0176D3] transition-colors uppercase">
              ...
              {paginatedIncidents.length === 0 ? (
                ...
                paginatedIncidents.map((incident) => (
                  <TableRow key={incident.id} className="group hover:bg-muted/10 transition-all border-b last:border-0 cursor-pointer" onClick={() => window.location.href = `/incidents/${incident.id}`}>
                    <TableCell className="pl-8 py-3 w-[120px]">
                    ...
                    <TableCell className="py-3 w-[180px]">
                      <div className="flex items-center gap-3">
                        <div className="size-7 bg-muted flex items-center justify-center font-bold text-[10px] text-muted-foreground border">
                        ...
                        <div className="flex flex-col min-w-0">
                          ...
                          <span className="text-[9px] font-medium text-muted-foreground uppercase truncate">{(incident.reporter?.department as any)?.name || "Dept"}</span>
                        </div>
                      </div>
                    </TableCell>
                    <TableCell className="py-3 w-[180px]">
                      <div className="flex flex-col">
                        ...
                        <span className="text-[9px] font-medium text-muted-foreground uppercase truncate">{(incident.location as any)?.name || "Site"}</span>
                      </div>
                    </TableCell>
                    <TableCell className="py-3 w-[180px]">
                       <div className="flex flex-col">
                          <span className="text-xs font-bold text-foreground truncate">{incident.category?.name || "Unclassified"}</span>
                          <span className="text-[9px] font-medium text-muted-foreground uppercase truncate">Dept: {(incident.department as any)?.name}</span>
                       </div>
                    </TableCell>
                    <TableCell className="py-3 text-center w-[60px]">
                       {incident.attachments?.length > 0 ? (
                         <div onClick={(e) => e.stopPropagation()}>
                           <Popover>
                              <PopoverTrigger 
                                className="h-8 px-2 gap-2 hover:bg-primary/10 group flex items-center justify-center rounded-md transition-colors border-none bg-transparent cursor-pointer mx-auto"
                              >
                    ...
                    <TableCell className="py-3 text-center w-[110px]">
                      <Badge 
                        variant="outline" 
                        className={cn(
                    ...
                    <TableCell className="pr-8 text-right py-3 w-[60px]">
                      <Button 
                        variant="ghost" 
                        size="icon" 
